...
public class WaitingResponse {
    ...
    @Builder
    private WaitingResponse(Long waitingId, Long userId,Long shopId,String shopName, int headCount,
                            WaitingStatus waitingStatus, int waitingNumber, int myWaitingOrder,
